...
namespace PrimeNGTableReusableComponent.Controllers {
    ...
    public class MainController : ControllerBase {
        private readonly primengTableReusableComponentContext _context; // Injection of the context
        ...
        public MainController(primengTableReusableComponentContext context) {
            _context = context;
        }
